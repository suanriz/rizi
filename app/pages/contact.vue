...
<template>
  <section class="contentWrap flex flex-col items-center">
    ...
    <div class="contactWrap max-w-[800px] w-full">
      ...
      >
        <div class="contactItem contactFull:!w-[50%] contactFull:pr-[4%]">
          <label for="cause" class="contactLabel">聯絡事項</label>
          <select
            id="cause"
        ...
        <div class="flex flex-wrap w-full contactFull:flex-nowrap">
          <div class="contactItem contactFull:!w-[50%] contactFull:!flex-nowrap">
            <label for="name" class="contactLabel">姓名</label>
            <input
              id="name"
              ...
              name="input_name"
              required
              class="contactInput contactFull:mr-[8%]"
            >
          </div>
          <div class="contactItem mt-[22px] contactFull:mt-0 contactFull:!w-[50%] contactFull:!flex-nowrap">
            <label for="email" class="contactLabel">信箱</label>
            <input
              id="email"
        ...
        <div class="contactItem">
          <label for="subject" class="contactLabel">主旨</label>
          <input
            id="subject"
        ...
        <div class="contactItem">
          <label for="content" class="contactLabel">內容</label>
          <textarea
            id="content"
